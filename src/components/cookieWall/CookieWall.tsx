        ...
        <div className={bem("content")}>
          <div className={bem("text")}>
            <span>
              ...
              eveniet nam sunt culpa! Reiciendis neque ratione assumenda
              blanditiis similique autem dolores ut earum at eveniet nemo
              laudantium, nihil sint a.
            </span>
